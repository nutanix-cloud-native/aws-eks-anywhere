...
// Mutate implements webhook.Admission so a webhook will be registered for the type.
func (r *NutanixDatacenterConfig) Mutate(_ admission.Request) admission.Response {
	nutanixdatacenterconfiglog.Info("mutate", "name", r.Name)
