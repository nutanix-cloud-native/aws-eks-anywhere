...
type NutanixMachineConfigSpec struct {
	...
	// Project is to identify the project so that machine resources can be linked to a Prism Central project
	// The project identifier (uuid or name) can be obtained from the Prism Central console
	// or using the Prism Central API.
	// +optional
